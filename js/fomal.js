...
function tonav() {
  ...
  document.getElementById("page-name").innerText = document.title.split(" | Comalhaut🥝")[0];
}
...
function createtime1() {
  var grt = new Date("02/26/2025 00:00:00"); //此处修改你的建站时间或者网站上线时间
...
function createtime() {
  ...
  // 网站诞生时间
  var grt = new Date("02/26/2025 00:00:00");
...
if (localStorage.getItem("blogbg") != undefined) {
  ...
  document.getElementById("defineBg").innerText = `:root{
    --default-bg: url(https://tuchuang.org.cn/imgs/2025/03/02/2265e85d05fd19b3.jpg);
    --darkmode-bg:url(https://tuchuang.org.cn/imgs/2025/03/02/2265e85d05fd19b3.jpg);
    --mobileday-bg: url(https://tuchuang.org.cn/imgs/2025/03/02/2265e85d05fd19b3.jpg);
    --mobilenight-bg: url(https://tuchuang.org.cn/imgs/2025/03/02/2265e85d05fd19b3.jpg);
  }`;
}
// 切换背景主函数
function changeBg(s) {
